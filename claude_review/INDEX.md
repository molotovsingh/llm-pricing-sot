...
|---|---|---|---|---|---|---|---|---|---|
| 5 | 2026-09-08 19:40 | `f0c48a7` | `main` | Adversarial second look at spec 005 (the `67bfe98` report was self-review). Four hermetic probes, four hits: `query review` mislabels flagged deployments (**P1**); deployment-only models invisible to plain `price`; truth-file edits ignored until the TTL; cross-check reads snapshots of any age. Core rules held. | 0 | 1 | 4 | 4 | [2026-09-08-f0c48a7.md](quality-pass/2026-09-08-f0c48a7.md) |
